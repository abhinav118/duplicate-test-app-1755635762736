    ...
    <div className="min-h-screen">
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
          <div className="container text-center">
            <h1 className="text-5xl font-bold mb-4">Duplicate Detection Dashboard</h1>
            <p className="text-xl opacity-90">Identify and manage duplicate records efficiently</p>
          </div>
        </div>
